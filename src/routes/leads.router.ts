...
router.post("/request-next", authenticateJWT, LeadsController.requestNextLead);
...
// Tipificación del ciclo de vida sobre un lead concreto (POST con sub-ruta, no colisiona)
