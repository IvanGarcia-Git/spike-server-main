...
import leadAssignmentRulesRouter from "./routes/lead-assignment-rules.router";
import leadStatsRouter from "./routes/lead-stats.routes";
...
import commissionTiersRouter from "./routes/commission-tiers.router";
...
app.use("/lead-assignment-rules", leadAssignmentRulesRouter);
app.use("/lead-stats", leadStatsRouter);
...
app.use("/commission-tiers", commissionTiersRouter);
