...
- hasSolarPanels: true si la factura indica autoconsumo, placas solares o cualquier compensación de excedentes. Márcalo true ante CUALQUIERA de estos términos o secciones: "autoconsumo", "modalidad de autoconsumo", "autoconsumo con excedentes", "excedentes", "excedentes vertidos", "compensación de excedentes", "compensación simplificada", "mecanismo de compensación", "saldo de excedentes", "energía vertida", "energía exportada", "vertido a red", "energía autoconsumida", "instalación fotovoltaica", "placas solares", o una línea/columna de "Excedentes" con kWh o con un importe en € (a menudo en negativo, como descuento). false SOLO si la factura es claramente sin autoconsumo. null si no se puede determinar.
- surplusCount: cantidad de excedentes de energía vertidos a la red en kWh durante el periodo (número, una ENERGÍA en kWh, NUNCA el precio en €/kWh ni el importe € compensado). Búscalo en líneas como "Excedentes", "Energía excedentaria", "Energía vertida", "Energía exportada" o "kWh vertidos a red". NO lo confundas con la energía CONSUMIDA (energias). null si no aplica o no aparece. IMPORTANTE: si detectas excedentes, autoconsumo o un precio/compensación de excedentes —aunque no tengas el valor exacto en kWh— marca hasSolarPanels como true de todos modos.
